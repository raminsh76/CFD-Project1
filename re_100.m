...
xlabel('x');
ylabel('y');
title(sprintf('Velocity Field Re=100 q=%0.2f t=%0.2f',q,t));
...
ylabel('y');
colorbar
title(sprintf('Streamlines Re=100 q=%0.2f t=%0.2f',q,t));

subplot(2,2,3)
contourf(x,y,abs(omega'),40,'LineColor','none' )
xlabel('x');ylabel('y');
colorbar
title(sprintf('Vorticity Re=100 q=%0.2f t=%0.2f',q,t));